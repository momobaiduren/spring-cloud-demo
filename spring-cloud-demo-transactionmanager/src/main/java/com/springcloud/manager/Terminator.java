...
import com.springcloud.exception.SystemException;
import com.springcloud.factory.BeanFactoryAdapter;
...
public class Terminator implements Serializable {
   ...
   * @return
   */
  private Object invoke(InvocationContext invocationContext) throws SystemException {

    if (!StringUtils.isEmpty(invocationContext.getMethodName())) {
