...
public interface MergeHandler {
    default void banchExecut( List<Integer> shardingData, Map<Class<MergeHandler>, List<?>> result){
     ...
     */
    void execut(Integer sharding, Map<Class<MergeHandler>, List<?>> result);
    /**
     * create by ZhangLong on 2019/11/14
     * description 补偿数据
     */
    void compensate(Map<Class<MergeHandler>, List<?>> result);
    /**
     * create by ZhangLong on 2019/11/14
